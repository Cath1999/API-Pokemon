...
import ni.edu.uca.pokemon.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun buscarDatosPokemon() {
        CoroutineScope(Dispatchers.Main).launch {
            try {
                val txtFiltro: String = binding.edtId.text.toString()
                ...
                if (call.isSuccessful){
                    ...
                    binding.txtExperiencia.text = "$exp"
                    binding.txtPeso.text = "$peso Kg"
                    binding.txtAltura.text = "$altura cm"

                    Picasso.get().load("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/${id}.png").into(binding.imgPokemon)
                }else {
